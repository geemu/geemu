...
import com.chenfangming.manage.persistence.mapper.RoleMenuMapper;
...
public class MyFilterInvocationSecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
    ...
    public Collection<ConfigAttribute> getAttributes(Object object) throws IllegalArgumentException {
        ...
        //  查询所有菜单及其可以访问的角色
        List<MenuRoleView> permissionEntityList = roleMenuMapper.selectAllMenuRole();
        for (MenuRoleView m : permissionEntityList) {
            List<RoleEntity> roleEntityList = m.getRoleEntityList();
            String pattern = m.getMethod() + ":" + m.getPath();
